...
- Name: app.spec.ts >> abre detalhe de item contabil
- Location: e2e\app.spec.ts:732:1
...
Call log:
  - waiting for getByLabel('Visualizar item contabil')
    - locator resolved to <button type="button" aria-label="Visualizar item contabil" class="group relative inline-flex shrink-0 items-center justify-center gap-2 overflow-hidden rounded-lg text-sm font-semibold tracking-[-0.01em] transition duration-200 ease-out focus-visible:ring-2 focus-visible:ring-ring/70 focus-visible:ring-offset-2 focus-visible:ring-offset-background active:translate-y-px disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none border border-transparent text-foreground hover:border-border/6…>…</button>
